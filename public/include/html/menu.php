    ...
    <div id="menu">
        <div class="pure-menu">
            ...
            <a class="pure-menu-heading" href="/dbdoc/search.php">DBDOC</a>

            <ul class="pure-menu-list">
                <li class="pure-menu-item"><a href="/dbdoc/add_doc.php" class="pure-menu-link">Add doc</a></li>
                <li class="pure-menu-item"><a href="/dbdoc/search.php" class="pure-menu-link">Search</a></li>
            </ul>
        </div>
    </div>
